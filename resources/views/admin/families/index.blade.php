...
@else
    <div class="flex items-start sm:items-center p-4 mb-4 text-sm text-fg-brand-strong rounded-base bg-blue-100" role="alert">
    ...
    <p><span class="font-medium me-1">Info alert!</span> Todavía no hay familias de productos registradas.</p>
    </div>
@endif
